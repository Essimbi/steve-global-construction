...
import { LucideAngularModule, Zap, Settings, Sun, Droplet, Plug, ShowerHead, BrickWall, PaintBucket, Sparkles, Image as ImageIcon, Building2, Wrench, Trophy, Target, ShieldCheck, Award, Leaf, Plus, Minus, X, ChevronLeft, ChevronRight, ChevronDown, ImageOff, Facebook, Linkedin, MessageCircle, Mail, Phone, MapPin, Instagram, Twitter, Music, ShoppingCart, GraduationCap, Network } from 'lucide-angular';
